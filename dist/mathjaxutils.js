...
define(["require", "exports", './utils'], function (require, exports, utils) {
    ...
    exports.remove_math = function (text) {
        ...
        // it seems that with recent browsers (IE9, FF 35, Chrome 42, for example), the built-in browser split
        // function passes all the tests that the old IPython utils.regex_split function claimed it fixed
        // see http://web.archive.org/web/20130803042736/http://stevenlevithan.com/demo/split.cfm for the tests
        ...
        return { html: de_tilde(blocks.join("")), math: math };
    };
    //
